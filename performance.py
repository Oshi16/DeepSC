...
#parser.add_argument('--checkpoint-path', default='DeepSC_checkpoints/deepsc-Rayleigh-SNR12-lr1e-4', type=str)
#parser.add_argument('--checkpoint-path', default='DeepSC_checkpoints/deepsc-Rayleigh', type=str)
parser.add_argument('--checkpoint-path', default='DeepSC_checkpoints/deepsc-Rayleigh-SNR0-18-lr5e-4', type=str)
